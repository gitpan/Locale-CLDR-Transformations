	...
	default => sub { [
		...
		},
		{
			...
			data => [
				...
				{
					before  => q((?^u:#[b p m f d t n l g k h j q x r z c s])),
					after   => q((?^u:[1-5])),
					replace => q((?^u:ia)),
					result  => q(ㄧㄚ),
					revisit => 0,
				...
				},
				{
					before  => q(),
					after   => q(),
					replace => q((?^u:#tone1:pinyin\u0304or1)),
					result  => q(zhuyintypicallyunmarkedoruseˉ),
					revisit => 0,
				},
				{
					before  => q(),
				...
				{
					before  => q((?^u:#(?[[a-z] - [b p f d t l g k h j q x r z c s]]))),
					after   => q(),
					replace => q((?^u:2)),
					result  => q(ˊ),
					revisit => 0,
				...
				},
				{
					before  => q(),
					after   => q(),
					replace => q((?^u:#tone5(light):pinyintypicallyunmarkedoruse5)),
					result  => q(zhuyin˙),
					revisit => 0,
				},
				{
